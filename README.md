...
### SSL
Create SSL certificates if the broker is intended to listen on SSL.  This shell script will automate the process of creating SSL certs. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA3MzI1NjYzLC03NTQ1NjA2MTcsLTE5Mj
